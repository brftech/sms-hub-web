...
export function OnboardingTracker({
  ...
  const steps: OnboardingStep[] = [
    ...
    },
    {
      ...
      title: "Personal",
      description:
        "Complete your personal information and create your company.",
      icon: <User />,
    ...
    },
    {
      ...
      icon: <Building />,
      completed:
        brands.length > 0 && brands.some((b) => b.status === "approved"),
    ...
    },
    {
      ...
      icon: <Megaphone />,
      completed:
        campaigns.length > 0 && campaigns.some((c) => c.status === "approved"),
  ...
  const phases: OnboardingPhase[] = [
    {
      ...
      route:
        steps.find((s) => s.id === "auth" && !s.completed)?.route ||
    ...
    },
    {
      ...
      route:
        steps.find((s) => s.id === "business" && !s.completed)?.route ||
    ...
    },
    {
      ...
      route:
        steps.find((s) => s.id === "campaign" && !s.completed)?.route ||
    ...
    },
    {
      ...
      route:
        steps.find((s) => s.id === "setup" && !s.completed)?.route ||
  ...
  // Find current phase
  const currentPhase =
    phases.find((phase) => phase.steps.some((step) => !step.completed)) ||
    ...
    <TrackerContainer>
          ...
          <CardContent>
            ...
            {currentStep.id === "payment" &&
              ...
              !company?.stripe_subscription_id && (
                ...
                >
                  <span style={{ color: "#dc2626", fontSize: "1.25rem" }}>
                    ⚠️
                  </span>
                  <div>
                    <p
                    ...
                    <p style={{ color: "#7f1d1d", fontSize: "0.875rem" }}>
                      Your payment was not completed. Please click below to
                      complete your subscription and activate your account.
                    </p>
                  </div>
                </div>
              )}
      ...
      {completedSteps === steps.length && (
        <CurrentStepDetail>
          ...
          <CardContent>
            <DetailDescription>
              Congratulations! You've completed all onboarding steps and have
