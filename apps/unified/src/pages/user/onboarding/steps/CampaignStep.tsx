...
export function CampaignStep({ onComplete }: StepComponentProps) {
  ...
  const form = useForm<CampaignFormData>({
    defaultValues: {
      ...
      opt_in_message:
        "Reply YES to receive messages from " +
      ...
      help_message:
        ...
        hubConfig.displayName +
        " SMS, visit " +
        hubConfig.deploymentUrls.production +
        "/help or call support.",
      age_gated: false,
    ...
    <Card>
      ...
      <CardContent>
        <InfoBox>
          ...
          <InfoText>
            Campaign registration is required for A2P 10DLC messaging. Your
            campaign will be reviewed by carriers to ensure compliance with
            messaging guidelines. Approval typically takes 1-3 business days.
          </InfoText>
        </InfoBox>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    TCR requires a detailed description of your opt-in process
