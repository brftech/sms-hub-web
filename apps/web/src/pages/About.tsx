        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-orange-500/20 border border-orange-500/30 mb-6">
              ...
              <span className="text-xs font-medium text-orange-400">WHY WE EXIST</span>
            </div>
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-8">
              Cigar retailers, private clubs, and premium venues get rejected by traditional SMS platforms. 
          ...
          <div className="mb-16">
            <div className="card-modern rounded-2xl p-8">
              <div className="flex flex-col lg:flex-row items-center gap-8">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white mb-4">Built by someone who gets it</h2>
                  <p className="text-gray-300 leading-relaxed mb-4">
                    <strong>Bryan</strong> spent years watching quality businesses get rejected by SMS platforms 
                    simply because of their industry. Cigar retailers were labeled "high-risk." 
                    Private clubs were deemed "non-compliant." Premium venues were turned away.
                  </p>
                  <p className="text-gray-300 leading-relaxed mb-4">
                    The problem wasn't these businesses - it was platforms that didn't understand 
                    regulated industries. So Bryan built one that does.
                  </p>
          ...
          <div className="mb-16">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                We don't just accept regulated businesses - we specialize in them.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-white">Other Platforms</h3>
                </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Compliance Expertise</h3>
                <p className="text-gray-400 text-sm">
                  We know your industry's regulations inside and out. No surprises, no violations.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">
                  You're not ticket #47291. You get dedicated support from people who know your name.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">
                  We handle everything. Setup in 7-10 days, not 6-8 weeks like competitors.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="card-modern rounded-2xl p-8">
              ...
              <p className="text-gray-300 mb-6 max-w-xl mx-auto">
                No more rejections. No more compliance headaches. Just SMS that works for your business.
              </p>
              <button
