          ...
          <div className="text-center mb-16">
            ...
            <div className="flex justify-center mb-6">
              <img
                ...
                className={`w-32 h-32 rounded-full object-cover border-4 ${hubColors.border} shadow-2xl`}
              />
            </div>

            <p className={`text-xl ${hubColors.text} font-semibold`}>
              Built by Bryan
            </p>
          </div>
                  ...
                  : currentHub === "percytech"
                    ...
                    : currentHub === "percymd"
                      ...
                      : currentHub === "percytext"
                        ? "PercyText"
                        : "Our platform"}{" "}
                exclusively serves establishments others reject, with deep
                expertise in premium hospitality. We've built custom platforms
                that reflect the sophistication of your establishment while
