      ...
      <div className="min-h-screen bg-black relative overflow-hidden">
        ...
        <div className="min-h-screen flex items-center justify-center px-4 sm:px-8 md:px-12 lg:px-24 xl:px-32 py-20">
          <div className={`w-full max-w-6xl text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8 tracking-tight leading-tight" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              <span className="text-white">Compliant</span> <span className="text-white">SMS</span> <span className="text-white">Cigar Texting</span>
            </h1>

            {/* Tagline */}
            <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-orange-400 mb-12 font-bold" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              <div className="mb-2">We do it well.</div>
              <div>Others don't do it all.</div>
            </div>
            ...
            {/* Call to Action */}
            <div className="text-xl sm:text-2xl md:text-3xl text-white mb-12 font-medium" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              Text 'PCA' to <span className="font-bold">757-XXX-XXXX</span>
            </div>
            
            <div className="text-lg sm:text-xl text-white mb-16 font-medium" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              cigar.gnymble.com
            </div>

            {/* Customer Testimonial */}
            <div className="bg-black/10 backdrop-blur-sm rounded-3xl border border-white/20 p-8 mb-16 max-w-4xl mx-auto">
              <p className="text-xl sm:text-2xl md:text-3xl text-orange-200 mb-6 font-medium italic" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
                "The first time we used Gnymble to publicize<br />an event...we had a <span className="text-white font-bold underline decoration-orange-300">record turnout!</span>"
              </p>
            ...
            {/* Bottom Text */}
            <div className="text-gray-300 text-base sm:text-lg mb-8" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              Texting rates apply. We respect your privacy and appreciate your trust.<br />
            ...
            <div className="flex justify-center items-center mb-16">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 px-8 py-6 flex items-center space-x-6">
                ...
                <div className="text-right">
                  <div className="text-white text-lg font-bold mb-1" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>PCA</div>
                  <div className="text-white text-sm opacity-80" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>Premium Cigar Association</div>
                  <div className="text-white text-xs opacity-60" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>Preferred Partner</div>
                </div>
              </div>
            </div>
      ...
      <div className="bg-black py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 md:px-12 lg:px-24 xl:px-32">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              Built for Cigar Retailers
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              From limited releases to customer loyalty programs, we understand the unique needs of premium cigar businesses.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
            <div className="text-center">
              ...
              <h3 className="text-white font-bold text-xl mb-4" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>TCR Compliant</h3>
              <p className="text-gray-400 leading-relaxed" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
                Full 10DLC registration and campaign approval for tobacco industry messaging. We handle the complexity.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-white font-bold text-xl mb-4" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>Premium Support</h3>
              <p className="text-gray-400 leading-relaxed" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
                Dedicated account management and same-day support for time-sensitive releases and events.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-white font-bold text-xl mb-4" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>Industry Expertise</h3>
              <p className="text-gray-400 leading-relaxed" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
                We specialize in regulated industries where others won't work. Your business is safe with us.
              </p>
            </div>
          </div>
          ...
          <div ref={formRef} id="contact-form" className="max-w-4xl mx-auto">
            <h3 className="text-2xl sm:text-3xl font-bold text-white mb-8 text-center" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
            ...
            <p className="text-gray-500 text-center mt-8 leading-relaxed" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              Join the premium cigar retailers who trust Gnymble for compliant customer communication.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700/50 p-8 shadow-2xl max-w-md w-full text-center">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Thank you for your interest. We'll respond within 24 hours with information specific to cigar retailers.
            </p>
          </div>
        </div>
      )}
