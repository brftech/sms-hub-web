        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
              <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-6 hover:border-orange-500/30 transition-all duration-300 hover:transform hover:scale-105">
          ...
          <div className="mb-20">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-3xl border border-gray-700/50 p-8 shadow-2xl relative overflow-hidden">
                {/* Background pattern */}
