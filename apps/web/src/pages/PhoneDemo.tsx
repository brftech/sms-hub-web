        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              This is exactly what your customers experience when you send them
              SMS messages. Professional, engaging, and compliant.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="card-modern rounded-2xl p-8 max-w-2xl mx-auto">
              ...
              <p className="text-gray-300 mb-6">
                Want to see how easy it is to send these messages? Check out the
                platform demo to see the business dashboard.
              </p>
