        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-20">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 leading-tight">
              <span className="block">Platform Demo</span>
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Experience the business side of our SMS platform. This is where businesses manage 
              conversations, respond to customers, and monitor their SMS campaigns in real-time.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-orange-500/10 to-purple-500/10 border border-orange-500/20 rounded-3xl p-12 backdrop-blur-sm">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Open the Phone Demo in another tab to see real-time interaction between 
                customer and business. Experience the full conversation flow.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  onClick={() => window.open('/phone-demo', '_blank')}
