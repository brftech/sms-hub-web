...
const Pricing = () => {
  ...
  const onboardingPlan = {
    ...
    type: "one-time setup",
    description:
      "Everything you need to start texting your customers compliantly.",
    features: [
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-8">
              One simple fee gets you set up, compliant, and ready to text. No
              contracts. No hidden costs. No rejections.
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {everyPlanIncludes.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center p-4 bg-black/40 rounded-xl border border-gray-800/50"
                >
