...
export function SuperadminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/superadmin-auth`, {
        method: "POST",
        headers: {
      ...
      <LoginContainer>
        <Card className="w-full max-w-md">
          <CardContent className="text-center py-12">
            ...
            <h2 className="text-2xl font-bold mb-2 text-gray-900">Superadmin Authenticated!</h2>
      ...
      <Card className="w-full max-w-md bg-gray-900/50 backdrop-blur-sm border-gray-700">
        <CardHeader>
          <div className="text-center mb-6">
            ...
            <CardTitle className="text-2xl text-white">Superadmin Access</CardTitle>
