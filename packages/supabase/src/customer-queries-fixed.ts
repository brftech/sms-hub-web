...
export const useCreateCustomer = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      ...
      queryClient.invalidateQueries({ queryKey: ['customer-by-company', data.company_id] })
      queryClient.invalidateQueries({ queryKey: ['customer-by-user', data.user_id] })
    },
  })
}
...
export const useUpdateCustomer = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      queryClient.invalidateQueries({ queryKey: ['customer-subscription', data.id] })
      queryClient.invalidateQueries({ queryKey: ['current-customer'] })
