// NOTE: RLS (Row Level Security) is currently DISABLED on all tables for debugging purposes
// This allows unrestricted access to all data. This should be re-enabled in production.
// See migration: 20250911175225_disable_rls_policies.sql
