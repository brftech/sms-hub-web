...
export type CampaignPhoneAssignment =
  Database["public"]["Tables"]["campaign_phone_assignments"]["Row"];
export type TCRIntegration =
  Database["public"]["Tables"]["tcr_integrations"]["Row"];
export type BandwidthAccount =
  Database["public"]["Tables"]["bandwidth_accounts"]["Row"];
