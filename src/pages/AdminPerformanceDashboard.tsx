        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
              ...
              <MetricCard
                ...
                value={coreWebVitals.INP?.value ?? "N/A"}
                rating={coreWebVitals.INP?.rating}
                unit="ms"
                subtitle="< 200ms is good"
              />
              <MetricCard
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              ...
              <MetricCard
                title="Failed"
                value={apiStats.failed}
                rating={apiStats.failed > 0 ? "poor" : "good"}
              />
              <MetricCard
                title="Avg Duration"
                  ...
                  {Object.entries(apiStats.byEndpoint).map(([endpoint, stats]) => (
                    ...
                    >
                      ...
                      <div className="flex gap-4 text-sm">
                        ...
                        <span
                          className={stats.avgDuration < 500 ? "text-green-500" : "text-yellow-500"}
                        >
                    ...
                    .map(([component, stats]) => (
                      ...
                      >
                        ...
                        <div className="flex gap-4 text-sm">
                          ...
                          <span
                            className={
                              stats.avgDuration < 16 ? "text-green-500" : "text-yellow-500"
                            }
                          >
                            {stats.avgDuration.toFixed(2)}ms avg
                          </span>
                          <span
                            className={stats.maxDuration < 50 ? "text-green-500" : "text-red-500"}
                          >
                  ...
                  {bundleStats.bundles.slice(0, 20).map((bundle, idx) => (
                    ...
                    >
                      ...
                      <div className="flex gap-4 text-sm">
                        ...
                        <span
                          className={bundle.loadTime < 1000 ? "text-green-500" : "text-yellow-500"}
                        >
