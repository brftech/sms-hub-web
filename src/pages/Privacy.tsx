  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Privacy policy for SMS marketing and communication services. Learn how we protect your data and respect your privacy."
      );
    }
  }, []);
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-2xl">3. SMS Marketing Consent</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    We only send SMS messages to customers who have explicitly opted in to receive
                    them. You can opt in by:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground mt-2">
                      <li>Active customer data: Until you opt out or request deletion</li>
                      <li>Communication records: 3 years for compliance purposes</li>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-2xl">5. Third-Party Services</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    We work with trusted third-party service providers to deliver SMS messages and
                    manage our communications. These partners are bound by strict data protection
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-2xl">6. Your Rights & Choices</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-2xl">7. Compliance & Regulations</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-muted-foreground">privacy@gnymble.com</p>
                    </div>
                    <div>
            ...
            <div className="mt-12 text-center">
              <p className="text-sm text-muted-foreground">
                ...
                significant changes via email or SMS.
              </p>
            </div>
          </div>
        </div>
